...
N deve ser lido na primeira linha da entrada. Cada caso de teste é composto por duas linhas, cada uma contendo uma string. 
...
for i in range(n):
    jogador1 = input()
    jogador2 = input()
    if jogador1 == 'ataque' and jogador2 == 'pedra' or jogador1 == 'pedra' and jogador2 == 'papel' or jogador1 == 'ataque' and jogador2 == 'papel':
        print('Jogador 1 venceu')
    elif jogador1 == 'pedra' and jogador2 == 'ataque' or jogador1 == 'papel' and jogador2 == 'pedra' or jogador1 == 'papel' and jogador2 == 'ataque':
